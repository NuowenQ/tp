...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB
                ...
                + ADDRESS_DESC_BOB + DATE_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + ROLE_DESC_BACKEND_DEVELOPER + EMAIL_DESC_BOB
                        + WEBSITE_DESC_BOB + ADDRESS_DESC_BOB + DATE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + ROLE_DESC_BACKEND_DEVELOPER + EMAIL_DESC_BOB
                        + VALID_WEBSITE_BOB + ADDRESS_DESC_BOB + DATE_DESC_BOB,
                expectedMessage);

        // missing address prefix
        assertParseFailure(parser, NAME_DESC_BOB + ROLE_DESC_BACKEND_DEVELOPER + EMAIL_DESC_BOB
                        + WEBSITE_DESC_BOB + VALID_ADDRESS_BOB + DATE_DESC_BOB,
                expectedMessage);

        // missing date prefix
        assertParseFailure(parser, NAME_DESC_BOB + ROLE_DESC_BACKEND_DEVELOPER + EMAIL_DESC_BOB
                        + WEBSITE_DESC_BOB + ADDRESS_DESC_BOB + VALID_DATE_BOB,
                expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser,
                INVALID_COMPANY_NAME_DESC + ROLE_DESC_BACKEND_DEVELOPER
                        + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + WEBSITE_DESC_BOB + DATE_DESC_BOB
        ...
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_ROLE_DESC + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + WEBSITE_DESC_BOB + DATE_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Role.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + ROLE_DESC_BACKEND_DEVELOPER
                + INVALID_EMAIL_DESC + ADDRESS_DESC_BOB + WEBSITE_DESC_BOB + DATE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Email.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + ROLE_DESC_BACKEND_DEVELOPER
                + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC + WEBSITE_DESC_BOB + DATE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Address.MESSAGE_CONSTRAINTS);

        // invalid website
        assertParseFailure(parser, NAME_DESC_BOB + ROLE_DESC_BACKEND_DEVELOPER
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + INVALID_WEBSITE_DESC + DATE_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Website.MESSAGE_CONSTRAINTS);

        // invalid date
        assertParseFailure(parser, NAME_DESC_BOB + ROLE_DESC_BACKEND_DEVELOPER
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + WEBSITE_DESC_BOB + INVALID_DATE_DESC
        ...
        assertParseFailure(parser, INVALID_COMPANY_NAME_DESC + ROLE_DESC_BACKEND_DEVELOPER + EMAIL_DESC_BOB
                        + WEBSITE_DESC_BOB + DATE_DESC_BOB + INVALID_ADDRESS_DESC,
                CompanyName.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + ROLE_DESC_BACKEND_DEVELOPER
                        + EMAIL_DESC_BOB + WEBSITE_DESC_BOB + ADDRESS_DESC_BOB + DATE_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
