...
public class ParserUtilTest {
    ...
    @Test
    public void parseName_invalidValue_throwsParseCompanyException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseCompanyName(INVALID_NAME));
    }

    @Test
    public void parseName_validValueWithoutWhitespace_returnsCompanyName() throws Exception {
        CompanyName expectedName = new CompanyName(VALID_NAME);
        assertEquals(expectedName, ParserUtil.parseCompanyName(VALID_NAME));
    }

    @Test
    public void parseName_validValueWithWhitespace_returnsTrimmedCompanyName() throws Exception {
    ...
    public void parseWebsite_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> ParserUtil.parseWebsite(null));
    }
