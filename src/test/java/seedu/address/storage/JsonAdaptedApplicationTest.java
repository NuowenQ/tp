...
public class JsonAdaptedApplicationTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedApplication application =
                new JsonAdaptedApplication(INVALID_COMPANY_NAME, VALID_ROLE, VALID_EMAIL, VALID_WEBSITE,
                        VALID_ADDRESS, VALID_DATE, VALID_STATUS, null, null, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedApplication application = new JsonAdaptedApplication(null, VALID_ROLE, VALID_EMAIL,
                VALID_WEBSITE, VALID_ADDRESS, VALID_DATE, VALID_STATUS, null, null, VALID_TAGS);
    ...
    @Test
    public void constructor_nullWebsite_roundTripSuccess() throws Exception {
        Application application = new ApplicationBuilder(BENSON)
                .withWebsite(null)
                .build();
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedApplication application =
                new JsonAdaptedApplication(VALID_COMPANY_NAME, VALID_ROLE, VALID_EMAIL, VALID_WEBSITE,
                        INVALID_ADDRESS, VALID_DATE, VALID_STATUS, null, null, VALID_TAGS);
    ...
    public void toModelType_invalidDate_throwsIllegalValueException() {
        JsonAdaptedApplication application =
                new JsonAdaptedApplication(VALID_COMPANY_NAME, VALID_ROLE, VALID_EMAIL, VALID_WEBSITE,
                        VALID_ADDRESS, INVALID_DATE, VALID_STATUS, null, null, VALID_TAGS);
    ...
    public void toModelType_nullDate_throwsIllegalValueException() {
        JsonAdaptedApplication application = new JsonAdaptedApplication(VALID_COMPANY_NAME, VALID_ROLE, VALID_EMAIL,
                VALID_WEBSITE, VALID_ADDRESS, null, VALID_STATUS, null, null, VALID_TAGS);
    ...
    public void toModelType_invalidStatus_throwsIllegalValueException() {
        JsonAdaptedApplication application =
                new JsonAdaptedApplication(VALID_COMPANY_NAME, VALID_ROLE, VALID_EMAIL, VALID_WEBSITE,
                        VALID_ADDRESS, VALID_DATE, INVALID_STATUS, null, null, VALID_TAGS);
    ...
    public void toModelType_nullStatus_throwsIllegalValueException() {
        JsonAdaptedApplication application = new JsonAdaptedApplication(VALID_COMPANY_NAME, VALID_ROLE, VALID_EMAIL,
                VALID_WEBSITE, VALID_ADDRESS, VALID_DATE, null, null, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedApplication application =
                new JsonAdaptedApplication(VALID_COMPANY_NAME, VALID_ROLE, VALID_EMAIL, VALID_WEBSITE,
                        VALID_ADDRESS, VALID_DATE, VALID_STATUS, null, null, invalidTags);
        assertThrows(IllegalValueException.class, application::toModelType);
    }

    @Test
    public void toModelType_missingArchiveField_defaultsToFalse() throws Exception {
        JsonAdaptedApplication application =
                new JsonAdaptedApplication(VALID_COMPANY_NAME, VALID_ROLE, VALID_EMAIL, VALID_WEBSITE,
                        VALID_ADDRESS, VALID_DATE, VALID_STATUS, null, null, VALID_TAGS);

        assertEquals(false, application.toModelType().isArchived());
    }
}
